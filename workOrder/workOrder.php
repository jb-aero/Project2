...
<html lang="en">
  ...
  <body>
	...
	<center><font size = 15 color="red"><?php echo($_GET['url']); ?></center></font>
	<br>
	<br>
	<br>
    <div id="form">
	...
	<b><font size = 15 >Description:</font></b> <br><br><textarea name='description' id='description' rows="6" cols="100"></textarea><br><br>
	<b><font size = 15>Priority:</b></font> <br>
